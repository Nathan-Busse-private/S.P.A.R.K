 ...
 */
spark_pwm::spark_pwm(const uint8_t addr)
 ...
 */
void spark_pwm::begin(uint8_t prescale) {
  _i2c->begin();
  reset();
  if (prescale) {
    setExtClk(prescale);
 ...
 */
void spark_pwm::setExtClk(uint8_t prescale) {
 ...
 */
void spark_pwm::setPWMFreq(float freq) {
#ifdef ENABLE_DEBUG_OUTPUT
 ...
 */
void spark_pwm::setOutputMode(bool totempole) {
 ...
 */
uint8_t spark_pwm::readPrescale(void) {
 ...
 */
uint8_t spark_pwm::getPWM(uint8_t num) {
 ...
 */
uint8_t spark_pwm::setPWM(uint8_t num, uint16_t on,
                                        uint16_t off) {
#ifdef ENABLE_DEBUG_OUTPUT
 ...
 */
void spark_pwm::setPin(uint8_t num, uint16_t val, bool invert) {
 ...
 */
void spark_pwm::writeMicroseconds(uint8_t num,
 ...
 * introspect)
 */
uint32_t spark_pwm::getOscillatorFrequency(void) {
 ...
 */
void spark_pwm::setOscillatorFrequency(uint32_t freq) {
  _oscillator_freq = freq;
}

/******************* Low level I2C interface */
uint8_t spark_pwm::read8(uint8_t addr) {
  _i2c->beginTransmission(_i2caddr);
  _i2c->write(addr);
...
void spark_pwm::write8(uint8_t addr, uint8_t d) {
  _i2c->beginTransmission(_i2caddr);
  _i2c->write(addr);
  _i2c->write(d);
  _i2c->endTransmission();
